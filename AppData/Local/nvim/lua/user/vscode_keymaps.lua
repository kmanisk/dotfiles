...
keymap("n", "<leader>gv", function() require('vscode').action('workbench.action.splitEditor') end, opts)
keymap("n", "<leader>gh", function() require('vscode').action('workbench.action.splitEditorDown') end, opts)
...
vim.api.nvim_set_keymap('n', '<leader>nf', ':lua require("vscode").action("filebunny.createFile")<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>nF', ':lua require("vscode").action("filebunny.createFolder")<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>lp', ':lua require("vscode").action("livePreview.start.preview.atFile")<CR>', { noremap = true, silent = true })
...
vim.keymap.set("n", "<leader>gq", "<cmd>lua require('vscode').action('workbench.action.toggleSidebarVisibility')<CR>", { desc = "Toggle Sidebar" })
...
vim.api.nvim_set_keymap("n", "<leader>oc", ":e $HOME/AppData/Local/nvim/lua/user/vscode_keymaps.lua<CR>", { noremap = true, silent = true })
...
for i = 1, 9 do
    keymap({"n", "v"}, string.format("<leader>h%d", i), 
    ...
    require('lazy').setup({
        ...
        { "wellle/targets.vim", lazy = false },
        {
            ...
            config = function()
                ...
                vim.api.nvim_set_keymap('n', 's', '<Cmd>lua require("leap").leap({ target_windows = { vim.fn.win_getid() } })<CR>', 
                    { noremap = true, silent = true })
            end
        },
        {

...
-- Rofi Wallpaper Selector (CTRL + SPACE remapped to Terminal Scratchpad)
-- hl.bind(
--     "CTRL + SPACE",
...
-- Rofi Powermenu (handled via SUPER + escape / ALT + escape; ALT + SHIFT + SPACE reserved for scratchpad)
-- hl.bind(
--     "ALT + SHIFT + SPACE",
...
cond_bind(
    "ALT + 0",
    hl.dsp.exec_cmd(dusky_scripts .. "waybar/waybar_toggle.sh --toggle"),
    { description = "Toggle Waybar (State Managed)" }
)
...
-- --- Notification Panel (Disabled per user preference; SUPER + N reserved for Notes Scratchpad) ---
-- hl.bind(
--     "SUPER + N",
...
-- Workspaces 1..3 moved via SUPER + CTRL + 1..3; SUPER + SHIFT + 1..3 reserved for nmtui/blueman/pavucontrol

...
local special_workspaces = {
    { name = "scratch-cmd",     on_created_empty = "alacritty --class scratch-cmd" },
    { name = "scratch-notes",   on_created_empty = "alacritty --class scratch-notes -e nvim /home/manisk/notes.md" },
    { name = "scratch-monitor", on_created_empty = "alacritty --class scratch-monitor -e btop" },
}

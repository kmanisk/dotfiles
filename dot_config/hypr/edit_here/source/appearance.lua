...
hl.config({
    ...
    -- ==========================================
    decoration = {
        rounding = 0, -- Flat corners (no rounding)
        rounding_power = 1.0, -- Curve used for rounding (2.0 is circle, 4.0 squircle, 1.0 triangular)
        active_opacity = 1.0, -- Full opacity for GUI apps
        inactive_opacity = 1.0, -- Full opacity for GUI apps
        ...
        blur = {
            ...
            size = 4, -- Subtle blur size
            passes = 2, -- Amount of passes
    ...
    -- ==========================================
    -- ANIMATIONS (DISABLED FOR MAXIMUM PERFORMANCE & INSTANT SWITCHING)
    -- ==========================================
    animations = {
        enabled = false,
    ...
    group = {
        ...
        groupbar = {
            ...
            rounding = 0, -- Round indicator
            rounding_power = 1.0, -- Curve used for rounding indicator
            gradient_rounding = 0, -- Round gradients
            gradient_rounding_power = 1.0, -- Curve used for rounding gradients
            round_only_edges = false, -- Round only indicator edges
            gradient_round_only_edges = false, -- Round only gradient edges
...
hl.workspace_rule({ workspace = "w[tv1]s[false]", gaps_out = 3, gaps_in = 2, border_size = 1 })
hl.workspace_rule({ workspace = "f[1]s[false]",   gaps_out = 2, gaps_in = 2, border_size = 1 })
